...
*{box-sizing:border-box}html,body{margin:0;width:100%;height:100%;overflow:hidden;background:var(--bg);color:var(--text);font:12px Segoe UI,Arial,sans-serif}
  #app{display:grid;grid-template-columns:minmax(0,1fr) 405px;height:100vh}#view{position:relative;min-width:0;background:#76acc7}#c{width:100%;height:100%;display:block;cursor:grab}#c.drag{cursor:grabbing}
