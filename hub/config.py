...
class HubConfig:
    ...
    prosody_rescue_min_stage1_confidence: float = 0.75
    ...
    def from_env(cls) -> "HubConfig":
        return cls(
            ...
            yamnet_single_strong_threshold=_env_float("YAMNET_SINGLE_STRONG_THRESHOLD", 0.75),
            prosody_rescue_min_stage1_confidence=_env_float("PROSODY_RESCUE_MIN_STAGE1_CONFIDENCE", 0.75),
